...
Until PyPI Trusted Publishing is fixed, install from GitHub:
...
After the PyPI project is live, install with:
...
The prepared PyPI distribution is `psycgod-sage`; the installed CLI command is `sage`.
